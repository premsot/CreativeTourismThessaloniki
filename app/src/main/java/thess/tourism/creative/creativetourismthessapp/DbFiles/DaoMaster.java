...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        StartPointDao.createTable(db, ifNotExists);
        CreatorDao.createTable(db, ifNotExists);
        BikesParkingPoisDao.createTable(db, ifNotExists);
    }
    
    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        CategoryDao.dropTable(db, ifExists);
        StartPointDao.dropTable(db, ifExists);
        CreatorDao.dropTable(db, ifExists);
        BikesParkingPoisDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(StartPointDao.class);
        registerDaoClass(CreatorDao.class);
        registerDaoClass(BikesParkingPoisDao.class);
    }
